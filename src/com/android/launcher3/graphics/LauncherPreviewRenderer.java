...
import com.android.launcher3.corvus.icon.CorvusIconFactory;
...
public class LauncherPreviewRenderer {
    ...
    public LauncherPreviewRenderer(Context context, InvariantDeviceProfile idp, boolean migrated) {
        ...
        CorvusIconFactory iconFactory =
                new CorvusIconFactory(context, mIdp.fillResIconDpi, mIdp.iconBitmapSize) { };
